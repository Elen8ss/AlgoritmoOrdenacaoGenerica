...
public class TreeSortDecreasing <T extends Comparable<? super T>> implements StrategeySort<T> {
    ...
    public void sort(T[] array) {
        ...
        raiz = null;
        treeSort(array);  
        System.out.println("num de comparações Treee Sort Decrescente:" + numComparison);
        System.out.println("num de atribuições Tree Sort Decrescente:" + numAssignments);
